...
form.addEventListener('submit',function (e) {
    ...
    fetch(form.action, {
        ...
        if (response.ok) {
            alert('El mensaje ha sido enviado con éxito ✅','success');
            form.reset();
        } else {
            alert('Hubo un error. Intenta nuevamente ❌','danger');
        }
    }).catch(()=> {
        appendAlert('Error en la conexión. Vuelve a intentarlo ⚠️','warning')
    })
});
